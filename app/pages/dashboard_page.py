...
def animate_chart(data, show_volume, show_moving_avg, show_bands, theme):
...
def render(data):
    ...
    if st.button("Start Replay Animation"):
        animate_chart(data, show_volume, show_moving_avg, show_bands, theme)
        return  # Skip rendering static chart after animation
